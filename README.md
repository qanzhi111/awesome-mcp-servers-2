...
- **[x402 Crypto API](https://github.com/qanzhi111/x402-crypto-api)** - Paid crypto & Web3 security data for AI agents. Real-time prices, market data, address analysis, token security, contract risk, and on-chain investigations via x402 payment protocol.
